...
// export const TimeOff: React.FC = () => {
//   const { user } = useAuth();
//   const [timeoffRequests] = useState(dummyTimeoffRequests);
...
//   const pendingRequests = timeoffRequests.filter(req => req.status === 'pending').length;
//   const approvedRequests = timeoffRequests.filter(req => req.status === 'approved').length;
//   const totalDaysThisYear = 25; // Dummy data
//   const usedDays = 8;
...
//             <FiCalendar className="text-indigo-500 mr-3" size={24} />
//             <div>
//               <p className="text-gray-600 dark:text-gray-400 text-sm">Total Days</p>
//               <p className="text-2xl font-bold text-gray-800 dark:text-white">{totalDaysThisYear}</p>
//             </div>
//           </div>
//         </motion.div>
...
//             <div>
//               <p className="text-gray-600 dark:text-gray-400 text-sm">Used Days</p>
//               <p className="text-2xl font-bold text-gray-800 dark:text-white">{usedDays}</p>
//             </div>
//           </div>
//         </motion.div>
...
//               <p className="text-2xl font-bold text-gray-800 dark:text-white">{totalDaysThisYear - usedDays}</p>
//             </div>
//           </div>
//         </motion.div>
...
//               <p className="text-2xl font-bold text-gray-800 dark:text-white">{pendingRequests}</p>
//             </div>
//           </div>
//         </motion.div>
//       </div>
